...
document.querySelectorAll("#menu_button_setting")[0].addEventListener("touchend", () => {
    document.querySelectorAll("#menu_setting")[0].classList.toggle("open");
...
document.querySelectorAll("#menu_setting, #menu_setting+*").forEach(_E0 => _E0.style.backgroundColor = "rgba(180,180,180,1)");
document.querySelectorAll("#menu_setting+*>*").forEach(_E0 => setting_node_color(_E0));

function setting_node_color(elem) {
    let start = [180, 180, 180, 1];
    let end = [0, 76, 113, 1];
    let percent = 0.15;
